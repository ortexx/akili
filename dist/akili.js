  ...
  _createClass(For, [{
    ...
    value: function loop(key, value, index) {
      ...
      if (this.iterators.length > index) {
        ...
        if (!_utils2.default.comparePreviousValue(value, value, iterator.comparisonValue)) {
          iterator.setValue();
        } else {
