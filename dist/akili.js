...
var Component = function () {
  ...
  _createClass(Component, [{
    ...
    value: function __initializeNode(node, el) {
      ...
      var val = node[node instanceof window.Attr ? 'value' : 'nodeValue'];
